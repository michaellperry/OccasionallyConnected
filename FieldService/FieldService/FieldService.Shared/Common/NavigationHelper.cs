...
namespace FieldService.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        {
            this.Page = page;
            this.CanGoBackHandler = CanGoBack;
            this.GoBackHandler = GoBack;
        ...
        public Action GoBackHandler { get; set; }
        public Func<bool> CanGoBackHandler { get; set; }
